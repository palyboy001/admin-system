<template>
    <div class="container flex row">
        <div class="userImage flex center">
            <img :src="comment.sendUser.infoImage" />
        </div>
        <div class="userInfo flex column">
            <div class="title">昵称：{{ comment.sendUser.nikeName }}</div>
            <div class="id">校园号：{{ comment.sendUser.userAccount }}</div>
        </div>
        <div class="topicAttribute flex column">
            <div class="time">
                <span class="AttrTitle">发布时间：</span>
                <span class="AttrContent">{{ comment.sendTime }}</span>
            </div>
            <div class="zan">
                <span class="AttrTitle">话题ID：</span>
                <span class="AttrContent">{{ comment.comment.id }}</span>
            </div>
            <div class="zan">
                <span class="AttrTitle">地址：</span>
                <span class="AttrContent">{{ comment.sendUser.address }}</span>
            </div>
        </div>
...
const createTime = computed(() =>{
    return timestamp_to_Date(porps.comment.user.createTime);
})
