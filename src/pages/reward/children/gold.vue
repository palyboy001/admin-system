    ...
    <scrollContentBox :topClientHeight="topHeight" @ScrollBottom="loadImg">
      <div>
        ...
        <div id="await" ref="await">
          ...
          <el-empty description="空空如也~" v-if="empty_" />
        </div>
      </div>
    </scrollContentBox>
  </div>
...
import { ReportStrvice,Report } from '@/types/interfaces'
...
// 如果有一个为true，其余为必须置为false
const closeAllLoadingBtn = (currentBtn: string): void => {
