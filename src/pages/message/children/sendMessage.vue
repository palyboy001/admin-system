<template>
  <div class="container">
    <div class="top flex" ref="top">
      <search @getSearch="getSearch" :title="'请输入用户的id'"></search>
    </div>
    <scrollContentBox :topClientHeight="topHeight" @ScrollBottom="loadImg">
      <div>
        <message :message="item" v-for="item in messages"></message>
...
import { Message_ } from '@/types/interfaces'
...
// 保存话题数组
let messages = reactive<Array<Message_>>([]);
